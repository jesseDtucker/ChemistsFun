...
void Debug2DScene::Update(DX::StepTimer const& timer)
{
	if (!m_tracking)
	{
...
void Debug2DScene::CreateDeviceDependentResources()
{
...
void Debug2DScene::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
